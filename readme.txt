...
Edit: the plugin isn't owned by any of the current JPXS staff, the code written/helped by jpsh (a staff member) is a mere 8 lines out of 300+ This plugin was released *by* FierriFiet and all decisions based on the code are his, meanwhile I've been master banned, harrassed, and my servers crashed constantly over it, this is not a leak, this an official release, screw you, although I can't do anything about it, you shouldn't be able to do that over this. And for any of the players wanting to use this, you can, he (the fricking CREATOR of the code) gives you permission to use it via the GPL-3.0 license, just avoid the massive salt boot that will fall on you if you do.
